...
const IconOverlay = ({iconName}) => {
    ...
    return (
        <div className='absolute top-0 left-0 w-full h-full flex justify-center items-center text-center opacity-0 hover:opacity-100 transition-opacity duration-200'>
...
const ProjectCards = ( {projectName, iconData, isOpen} ) => {
    ...
    return (
        <div className={isOpen ? "open-card-container" : "card-container"}>
            ...
            {iconLen >= 4 ? <div className="small-card card relative overflow-hidden">
                <Image 
                        src={`/icons/${icon4}.svg`}
            ...
            {iconLen >= 1 ? <div className="small-card card relative overflow-hidden">
                <Image 
                        src={`/icons/${icon1}.svg`}
